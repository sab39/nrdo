///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.WhenLDefn
//
...
public class WhenLDefn extends LDefnElem {
  Expr condition;
  LDefnElem body;

  WhenLDefn(Expr condition, LDefnElem body) {
  ...
  public void addTo(List target, Context ctx, List sep) throws FileLocatedException,
      IOException {
    if (Bool.truth(condition.evaluate(ctx))) {
      if (sep != null) target.addAll(sep);
      body.addTo(target, ctx);
    }
  }
}
