///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.TimestampedExpr
//
...
public class TimestampedExpr extends Expr implements TimestampedObject {
  Expr body;
  List dependencies;
  long timestamp;

  TimestampedExpr(Expr body, List dependencies, long timestamp) {
    this.body = body;
  ...
  public void write(Context ctx, Writer out) throws IOException, FileLocatedException {
    body.write(ctx, out);
  }
