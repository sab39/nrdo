///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.Declare
//
...
class Declare extends DefnElem {
  String name;
  List given;
  Definition decl;

  Declare(String name, List given, Definition decl) {
    this.name = name;
    this.given = given;
    this.decl = decl;
  }

  public Context setOnContext(Context ctx) {
    ctx.vars.put("declare$" + name, new Declosure(this, ctx));
