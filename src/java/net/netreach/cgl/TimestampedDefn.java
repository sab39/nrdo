///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.TimestampedDefn
//
...
public class TimestampedDefn extends Definition implements TimestampedObject {
  Definition body;
  List dependencies;
  long timestamp;

  TimestampedDefn(Definition body, List dependencies, long timestamp) {
    this.body = body;
    this.dependencies = dependencies;
    this.timestamp = timestamp;
  }

  public Context setOnContext(Context ctx) throws IOException, FileLocatedException {
    return body.setOnContext(ctx);
  }

  public long resolve(Context ctx) throws IOException, FileLocatedException {
    return TimestampHelper.resolve(this, ctx);
  }
