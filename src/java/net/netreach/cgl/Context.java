///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.Context
//
...
public class Context {
  public Scope vars;
  public File srcbase = null;
  public long age = 0;
  long callerModified = Long.MIN_VALUE;
  ...
  public Context(Map vars) {
    this.vars = new Scope(vars);
  }

  protected Context(boolean ignore) {
  }

  public Context(Context ctx) {
    vars = new Scope(ctx.vars);
    srcbase = ctx.srcbase;
    age = ctx.age;
    deps = ctx.deps;
    callerModified = ctx.callerModified;
  }
}
