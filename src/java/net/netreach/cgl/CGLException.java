///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.CGLException
//
...
public class CGLException extends SmeltException {
	private static final long serialVersionUID = 2481203335539565333L;

	public CGLException(PositionedExpr expr, String msg) {
		super(expr.getLoc(), msg);
	}
}
