///////////////////////////////////////////////////////////////////////////////
// Class: net.netreach.cgl.BasicLDefn
//
...
public class BasicLDefn extends LDefnElem {
  Definition defn;

  BasicLDefn(Definition defn) {
    this.defn = defn;
  }
  ...
  public void addTo(List target, Context ctx, List sep) throws FileLocatedException,
    ...
    Context res = defn.setOnContext(ictx);
    if (res != ictx) {
      throw new RuntimeException("Illegal operation in 'list'");
    }
    target.add(ictx.vars.getFront());
  }
}
